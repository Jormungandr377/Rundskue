    ...
    <div className="max-w-lg mx-auto">
      ...
      <div className="bg-white rounded-xl shadow-sm border border-surface-100 p-8">
        <div className="flex items-center gap-3 mb-6">
          ...
          <div>
            <h2 className="text-xl font-bold text-surface-900">Change Password</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div>
            <label htmlFor="confirmNewPassword" className="block text-sm font-medium text-surface-700 mb-1">
              Confirm new password
            </label>
            <input
