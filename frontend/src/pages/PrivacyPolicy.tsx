      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-white dark:bg-surface-800 rounded-xl shadow-sm border border-surface-200 dark:border-surface-700 p-8 sm:p-10">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-surface-700 dark:text-surface-300 leading-relaxed">
              <li>
                <span className="font-medium text-surface-800 dark:text-surface-200">Access:</span> You
                can view all of your stored data within the application at any time.
              </li>
              <li>
                <span className="font-medium text-surface-800 dark:text-surface-200">Export:</span> You
          ...
          <section className="mb-8">
            ...
            <div className="mt-3 p-4 bg-surface-50 dark:bg-surface-700/50 rounded-lg">
