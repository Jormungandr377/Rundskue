...
export default function LoanTab() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 className="text-2xl font-bold text-surface-900 dark:text-white">Loan Calculator</h1>
      ...
      {/* Input Form */}
      <div className="card p-6">
        <h2 className="text-lg font-semibold text-surface-900 dark:text-white mb-4">Loan Details</h2>
          ...
          <div className={`grid gap-4 ${hasExtra ? 'grid-cols-2 lg:grid-cols-3 xl:grid-cols-6' : 'grid-cols-2 lg:grid-cols-4'}`}>
            <div className="card p-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-sm text-surface-500 dark:text-surface-400">Monthly Payment</p>
              </div>
            ...
            <div className="card p-4">
              ...
              {hasExtra && (
                <p className="text-xs text-surface-400 dark:text-surface-500 line-through mt-1">
            ...
            <div className="card p-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-sm text-surface-500 dark:text-surface-400">Total Cost</p>
              </div>
            ...
            <div className="card p-4">
              <div className="flex items-center gap-2 mb-1">
                ...
                <p className="text-sm text-surface-500 dark:text-surface-400">Payoff Date</p>
              </div>
              <p className="text-xl font-bold text-surface-900 dark:text-white">
              ...
              <>
                <div className="card p-4 border-green-200 dark:border-green-800 bg-emerald-50/50 dark:bg-emerald-900/10">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-sm text-surface-500 dark:text-surface-400">Time Saved</p>
                  </div>
                ...
                <div className="card p-4 border-green-200 dark:border-green-800 bg-emerald-50/50 dark:bg-emerald-900/10">
                  <div className="flex items-center gap-2 mb-1">
                    ...
                    <p className="text-sm text-surface-500 dark:text-surface-400">Interest Saved</p>
                  </div>
                  <p className="text-xl font-bold text-emerald-600 dark:text-emerald-400">
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-sm">
                <thead className="bg-surface-50 dark:bg-surface-700/50 border-b border-surface-200 dark:border-surface-700">
                  <tr>
                    <th className="text-left py-3 px-4 font-medium text-surface-600 dark:text-surface-300">Year</th>
                    <th className="text-right py-3 px-4 font-medium text-surface-600 dark:text-surface-300">Starting Balance</th>
                    <th className="text-right py-3 px-4 font-medium text-surface-600 dark:text-surface-300">Total Paid</th>
                    <th className="text-right py-3 px-4 font-medium text-surface-600 dark:text-surface-300">Principal</th>
                    <th className="text-right py-3 px-4 font-medium text-surface-600 dark:text-surface-300">Interest</th>
                    <th className="text-right py-3 px-4 font-medium text-surface-600 dark:text-surface-300">Ending Balance</th>
                    {hasExtra && (
                      <>
                        <th className="text-right py-3 px-4 font-medium text-emerald-600 dark:text-emerald-400 border-l border-surface-200 dark:border-surface-600">
                          Balance (w/ Extra)
                        </th>
                      ...
                      <tr
                        ...
                        className={`${
                          idx % 2 === 0
                            ...
                            : 'bg-surface-50/50 dark:bg-gray-750/50'
                        } ${extraPaidOff ? 'opacity-50' : ''}`}
                      >
                        <td className="py-3 px-4 font-medium text-surface-900 dark:text-white">{row.year}</td>
                        ...
                        <td className="py-3 px-4 text-right font-medium text-surface-900 dark:text-white">
                          {formatCurrency(row.endingBalance)}
                        </td>
                        {hasExtra && (
                          <>
                            <td className="py-3 px-4 text-right border-l border-surface-200 dark:border-surface-600 font-medium text-emerald-600 dark:text-emerald-400">
                ...
                <tfoot className="bg-surface-50 dark:bg-surface-700/50 border-t-2 border-surface-300 dark:border-surface-600">
                  <tr>
                    <td className="py-3 px-4 font-bold text-surface-900 dark:text-white">Total</td>
                    <td className="py-3 px-4 text-right text-surface-600 dark:text-surface-400">--</td>
                    <td className="py-3 px-4 text-right font-bold text-surface-900 dark:text-white">
                      {formatCurrency(result.totalCost)}
                    </td>
                    ...
                    {hasExtra && (
                      <>
                        <td className="py-3 px-4 text-right border-l border-surface-200 dark:border-surface-600 font-bold text-emerald-600 dark:text-emerald-400">
                          {formatCurrency(0)}
                        </td>
