      ...
      <div className="min-h-screen bg-surface-50 flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          <div className="bg-white rounded-xl shadow-sm border border-surface-100 p-8">
            <h2 className="text-lg font-semibold text-surface-900 mb-2">Invalid reset link</h2>
    ...
    <div className="min-h-screen bg-surface-50 flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <p className="text-surface-500 mt-2">Set a new password</p>
        </div>
                        ...
                        return (
                          <div key={check.label} className="flex items-center gap-2 text-xs">
                            {passed ? (
                              ...
                              <X className="w-3.5 h-3.5 text-surface-300" />
                            )}
                            <span className={passed ? 'text-emerald-600' : 'text-surface-400'}>
                              {check.label}
                            </span>
                          </div>
                        )
                ...
                <div>
                  ...
                  <input
                    ...
                    className={`w-full px-4 py-2.5 border rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none transition-colors ${
                      confirmPassword.length > 0 && !passwordsMatch ? 'border-red-300' : 'border-surface-300'
                    }`}
