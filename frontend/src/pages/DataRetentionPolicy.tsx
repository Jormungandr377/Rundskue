        ...
        <div className="bg-white dark:bg-stone-800 rounded-xl shadow-sm border border-stone-200 dark:border-stone-700 p-8 sm:p-10">
          ...
          <section className="mb-8">
            ...
            <p className="text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <a href="https://finance.rundskue.com" className="text-teal-600 dark:text-teal-400 hover:underline">
          ...
          <section className="mb-8">
            ...
            {/* User Account Data */}
            <h3 className="text-lg font-medium text-stone-800 dark:text-stone-200 mt-5 mb-3">
              User Account Data
            </h3>
              ...
              <table className="w-full text-sm border-collapse">
                <thead>
                  <tr className="border-b border-stone-200 dark:border-stone-600">
                    <th className="text-left py-2 pr-4 text-stone-800 dark:text-stone-200 font-medium">Data</th>
                    <th className="text-left py-2 text-stone-800 dark:text-stone-200 font-medium">Retention</th>
                  </tr>
                </thead>
          ...
          <section className="mb-8">
            ...
            <ol className="list-decimal list-inside space-y-2 text-stone-700 dark:text-stone-300 leading-relaxed">
            ...
            <div className="mt-4 p-4 bg-stone-50 dark:bg-stone-700/50 rounded-lg">
              <p className="text-sm text-stone-600 dark:text-stone-400 leading-relaxed">
                Data is deleted via standard SQL <code className="bg-stone-100 dark:bg-stone-600 px-1 py-0.5 rounded text-xs">DELETE</code> operations.
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <li>
                <span className="font-medium text-stone-800 dark:text-stone-200">Export:</span>{' '}
                Export your transaction data in CSV or Excel format through the application.
              </li>
              <li>
                <span className="font-medium text-stone-800 dark:text-stone-200">Access:</span>{' '}
