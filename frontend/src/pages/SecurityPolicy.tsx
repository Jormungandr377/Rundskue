        ...
        <div className="bg-white dark:bg-stone-800 rounded-xl shadow-sm border border-stone-200 dark:border-stone-700 p-8 sm:p-10">
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-stone-700 dark:text-stone-300 leading-relaxed">
              ...
              <li>CORS whitelist permits requests only from <code className="text-sm bg-stone-100 dark:bg-stone-700 px-1.5 py-0.5 rounded">finance.rundskue.com</code> and localhost (development).</li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc list-inside space-y-2 text-stone-700 dark:text-stone-300 leading-relaxed">
              <li><strong>CSRF protection</strong> via <code className="text-sm bg-stone-100 dark:bg-stone-700 px-1.5 py-0.5 rounded">X-Requested-With</code> header validation on mutating requests.</li>
          ...
          <section>
            ...
            <div className="p-4 bg-stone-50 dark:bg-stone-700/50 rounded-lg space-y-1">
